...
export default function FarmerSidebar() {
    ...
    const menuItems = [
        ...
        { name: "My Farm", href: "/farmer/farm", icon: Tractor },
        { name: "Applications", href: "/farmer/applications", icon: FileText },
    ];
    ...
    return (
        <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-screen z-20 shadow-sm">
            ...
            <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4 px-2 mt-2">Farmer Portal</div>
            ...
            <div className="p-4 border-t border-slate-100">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-slate-900 truncate">Farmer</p>
                        <p className="text-xs text-slate-500 truncate">farmer@email.com</p>
                    </div>
                    <button
                        onClick={() => {
